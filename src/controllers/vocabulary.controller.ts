...
class VocabularyController {
  createNewVocab = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  ...
  getOneVocabulary = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const user = req.user as IUserRequest
  ...
  getVocabularies = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const user = req.user as IUserRequest
    const data = await vocabularyService.getVocabularies(user)
    res.status(200).json({ message: 'Get all vocabulary successfully', data })
  })

  updateOneVocabulary = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const user = req.user as IUserRequest
    const { vocabId } = req.params
  ...
  deleteOneVocabulary = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const user = req.user as IUserRequest
    const { vocabId } = req.params
  ...
  searchVocabularies = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
    const user = req.user as IUserRequest
